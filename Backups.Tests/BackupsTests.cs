...
namespace Backups.Tests
{
    public class BackupsTests
    {
        ...
        public void SplitStoragesTest()
        {
            ...
            Assert.That(repository.FileSystem["/Users/navga228/Desktop/3лабаООП/BackUpJob1/JobObject"].Count == 1, Is.True); // Проверяем что в файловой системе сейчас один файл в jobObject тк второй мы удалилии
