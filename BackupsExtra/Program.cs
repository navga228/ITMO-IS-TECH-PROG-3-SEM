...
namespace BackupsExtra
{
    internal class Program
    {
        private static void Main()
        {
            ...
            BackupJobExtra backupJobExtra = new BackupJobExtra("BackupJob1", @"/Users/navga228/Desktop/BackupFiles/", singleStorageAlgorithmExtra, localFilesRepositoryExtra, fileLog, selectRpByQuantity, deleteRestorPoints);
            ...
            backupJobExtra.RemoveJobObject(file1);
            ...
            recoverDataFromRp.RecoverToDifferentLocation(backupJobExtra, backupJobExtra.GetBackupJob.RestorePoints[0], @"/Users/navga228/Desktop");
